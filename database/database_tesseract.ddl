...
CREATE TABLE tes_line(
    ...
    width INTEGER NOT NULL,
    height INTEGER NOT NULL,
    CONSTRAINT PRIMARY KEY pk_tline (id, paragraph_id, block_id, page_id, document_id),
...
CREATE TABLE tes_word(
    ...
    CONSTRAINT PRIMARY KEY pk_tline (id, line_id, paragraph_id, block_id, page_id, document_id),
